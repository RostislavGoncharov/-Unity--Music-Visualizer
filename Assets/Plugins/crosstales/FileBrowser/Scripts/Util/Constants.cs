namespace Crosstales.FB.Util
{
   ...
   public abstract class Constants : Crosstales.Common.Util.BaseConstants
   {
      ...
      public const string ASSET_VERSION = "2022.2.1";

      /// <summary>Build number of the asset.</summary>
      public const int ASSET_BUILD = 20221027;
      ...
      public static readonly System.DateTime ASSET_CHANGED = new System.DateTime(2022, 10, 27);
